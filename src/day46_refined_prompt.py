"""
Day 46 -- prompt refinement based on Day 45's real-world test results.

Two fixes:
1. Force the model to NAME the specific related function when an issue
   stems from a dependency -- makes claims verifiable, not vague.
2. Explicitly tell the model when there's NO related context, so it
   doesn't speculate about callers it has no information about.
"""
